<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="OrderFood.aspx.cs" Inherits="Gustoso.OrderFood" %>
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">פיצה מרגריטה</a></h3>
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6">
            <div class="product-grid">
                <div class="product-image">
                    <a href="#">
                        <img class="pic-1"  src="Photos/chocolate_cake.jpg" />
                    </a>
                    <ul class="social">
                        <li><a href="" data-tip="Add to Cart"><i class="fa fa-shopping-cart"></i></a></li>
                    </ul>
                ...
                <div class="product-content">
                    <h3 class="title"><a href="#">עוגת שוקולד</a></h3>
                    <div class="price">56.00₪
                    </div>
                    <a class="add-to-cart" href="">+ Add To Cart</a>
                </div>
