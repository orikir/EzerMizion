        ...
        <center>
            ...
            <asp:GridView ID="GridView1" runat="server" BackColor="White" OnRowCommand="GridView1_RowCommand"  BorderColor="Black" Width="1000px" BorderStyle="None" BorderWidth="1px" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1" CellPadding="4">
                <Columns>
                    ...
                    <%--<asp:TemplateField>
                        <ItemTemplate>
                            <asp:DropDownList ID="selectSta" CssClass="form-control" DataSourceID="SqlDataSource1" DataTextField="donStatus" DataMember="DefaultView" ViewStateMode="Inherit"   DataValueField="donStatus" runat="server" OnSelectedIndexChanged="selectSta_SelectedIndexChanged1"   Rows="1"   >
                            </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" SelectCommand="SELECT [donStatus] FROM [donStatus]"></asp:SqlDataSource>
